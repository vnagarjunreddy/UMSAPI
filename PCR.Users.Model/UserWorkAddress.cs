...
namespace PCR.Users.Model.ViewModels
{
    ...
    {
        [Required]
        [StringLength(60, ErrorMessage = "Email address should not exceed more than 60 characters")]
        ...
        [Required]
        [StringLength(maximumLength:40,MinimumLength =1, ErrorMessage = "LastName should not exceed more than 40 characters")]
        public string LastName { get; set; }

        [Required]
        [StringLength(maximumLength:25, MinimumLength = 1, ErrorMessage = "FirstName should not exceed more than 25 characters")]
        public string FirstName { get; set; }

        [StringLength(maximumLength:1, MinimumLength = 1, ErrorMessage = "MiddleName should not exceed more than 1 character")]
        ...
        [StringLength(maximumLength:40, MinimumLength = 1, ErrorMessage = "Other Name should not exceed more than 40 characters.")]
        ...
        public string SelectSteps { get; set; }
        public ICollection<OnBoardingEmployeeSteps> ListOnboardEmpSteps { get; set; }
               
        public ICollection<I9AcceptableDocumentPackages> ListI9AcceptableDocumentPackages { get; set; }
    }
}
